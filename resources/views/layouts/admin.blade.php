...
<head>
    ...
    <title>@yield('titre', 'Admin') — ITA Badging</title>
...
<div class="d-flex" style="min-height:100vh;">
    ...
    <nav class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.visiteurs') }}"
                   class="nav-link {{ request()->routeIs('admin.visiteurs*') ? 'active' : '' }}">
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a href="{{ route('admin.visiteurs.export') }}" class="nav-link">
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a href="{{ route('kiosque.index') }}" class="nav-link" target="_blank">
        ...
        <div class="sidebar-footer">
            &copy; {{ date('Y') }} ITA Badging System
        </div>
    </nav>
    ...
    <div class="main-content">
        <div class="topbar">
            <h1 class="mb-0">
                <i class="bi bi-qr-code-scan me-2" style="color:var(--ita-red);"></i>@yield('titre', 'Tableau de bord')
            </h1>
        ...
        <div class="page-body">
            ...
            @if(session('erreur'))
                <div class="alert alert-danger alert-dismissible fade show border-0 mb-3">
                    <i class="bi bi-exclamation-triangle me-2"></i>{{ session('erreur') }}
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
            @endif
