<?php $__env->startSection('titre', 'Accréditation confirmée — ITA 2026'); ?>
    ...
    <div class="container">
        <div class="d-flex flex-column align-items-center text-center gap-3">
            ...
            <div>
                ...
                <div class="welcome-name"><?php echo e($visiteur->prenom); ?> <?php echo e($visiteur->nom); ?></div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="qr-card">
                        ...
                        <img src="<?php echo e(route('visiteur.qr', $visiteur->token)); ?>"
                             alt="QR Code <?php echo e($visiteur->nom_complet); ?>">
                        <a href="<?php echo e(route('visiteur.telecharger-qr', $visiteur->token)); ?>"
                           class="btn-download">
                ...
                <div class="col-md-8">
                    ...
                    <div class="badge-recap">
                        <div class="badge-name"><?php echo e($visiteur->prenom); ?> <?php echo e($visiteur->nom); ?></div>
                        <?php if($visiteur->entreprise): ?>
                            <div class="badge-company"><?php echo e($visiteur->entreprise); ?></div>
                        <?php endif; ?>
                        <?php if($visiteur->fonction): ?>
                            <div class="badge-detail"><i class="bi bi-briefcase me-1"></i><?php echo e($visiteur->fonction); ?></div>
                        <?php endif; ?>
                        <?php if($visiteur->pays): ?>
                            <div class="badge-detail mt-1">
                                <span style="background:var(--ita-light);border:1px solid var(--ita-border);border-radius:3px;padding:2px 8px;font-size:.8rem;">
                                    <i class="bi bi-globe me-1"></i><?php echo e($visiteur->pays); ?>
                    ...
                    <div class="email-alert">
                        ...
                        <strong><?php echo e($visiteur->email); ?></strong>. Vérifiez vos spams si besoin.
                    </div>
                    ...
                    <div class="text-center mt-3">
                        <a href="<?php echo e(route('visiteur.formulaire', $visiteur->event->slug)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\js\Desktop\ALL THE WEBSITES\ITAF\resources\views/visitor/confirmation.blade.php ENDPATH**/ ?>